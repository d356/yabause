...
static void FASTCALL SH2undecoded(SH2_struct * sh)
{
   ...
   sh->regs.R[15]-=4;
   MappedMemoryWriteLongSh2(sh->regs.R[15],sh->regs.SR.all,sh);

   // Save regs.PC on stack
   sh->regs.R[15]-=4;
   MappedMemoryWriteLongSh2(sh->regs.R[15],sh->regs.PC + 2,sh);
   ...
   sh->regs.PC = MappedMemoryReadLongSh2(sh->regs.VBR+(vectnum<<2),sh);
   sh->cycles++;
}
...
static void FASTCALL SH2andm(SH2_struct * sh)
{
   ...
   temp = (s32) MappedMemoryReadByteSh2(sh->regs.GBR + sh->regs.R[0],sh);
   temp &= source;
   MappedMemoryWriteByteSh2((sh->regs.GBR + sh->regs.R[0]), temp, sh);
   sh->regs.PC += 2;
   sh->cycles += 3;
}
...
static void FASTCALL SH2ldcmgbr(SH2_struct * sh)
{
   ...
   sh->regs.GBR = MappedMemoryReadLongSh2(sh->regs.R[m], sh);
   sh->regs.R[m] += 4;
   sh->regs.PC += 2;
   sh->cycles += 3;
}
...
static void FASTCALL SH2ldcmsr(SH2_struct * sh)
{
   ...
   sh->regs.SR.all = MappedMemoryReadLongSh2(sh->regs.R[m], sh) & 0x000003F3;
   sh->regs.R[m] += 4;
   sh->regs.PC += 2;
   sh->cycles += 3;
}
...
static void FASTCALL SH2ldcmvbr(SH2_struct * sh)
{
   ...
   sh->regs.VBR = MappedMemoryReadLongSh2(sh->regs.R[m], sh);
   sh->regs.R[m] += 4;
   sh->regs.PC += 2;
   sh->cycles += 3;
}
...
{
   s32 m = INSTRUCTION_B(sh->instruction);
   sh->regs.MACH = MappedMemoryReadLongSh2(sh->regs.R[m], sh);
   sh->regs.R[m] += 4;
   sh->regs.PC += 2;
   sh->cycles++;
}
...
{
   s32 m = INSTRUCTION_B(sh->instruction);
   sh->regs.MACL = MappedMemoryReadLongSh2(sh->regs.R[m], sh);
   sh->regs.R[m] += 4;
   sh->regs.PC += 2;
   sh->cycles++;
}
...
{
   s32 m = INSTRUCTION_B(sh->instruction);
   sh->regs.PR = MappedMemoryReadLongSh2(sh->regs.R[m], sh);
   sh->regs.R[m] += 4;
   sh->regs.PC += 2;
   sh->cycles++;
}
...
static void FASTCALL SH2macl(SH2_struct * sh)
{
   ...
   tempn = (s32) MappedMemoryReadLongSh2(sh->regs.R[n],sh);
   sh->regs.R[n] += 4;
   tempm = (s32) MappedMemoryReadLongSh2(sh->regs.R[m],sh);
   sh->regs.R[m] += 4;
...
static void FASTCALL SH2macw(SH2_struct * sh)
{
   ...
   tempn=(s32) MappedMemoryReadWordSh2(sh->regs.R[n],sh);
   sh->regs.R[n]+=2;
   tempm=(s32) MappedMemoryReadWordSh2(sh->regs.R[m],sh);
   sh->regs.R[m]+=2;
   templ=sh->regs.MACL;
...
static void FASTCALL SH2movbl(SH2_struct * sh)
{
   ...
   sh->regs.R[n] = (s32)(s8)MappedMemoryReadByteSh2(sh->regs.R[m], sh);
   sh->regs.PC += 2;
   sh->cycles++;
}
...
static void FASTCALL SH2movbl0(SH2_struct * sh)
{
   ...
   sh->regs.R[n] = (s32)(s8)MappedMemoryReadByteSh2(sh->regs.R[m] + sh->regs.R[0], sh);
   sh->regs.PC += 2;
   sh->cycles++;
}
...
static void FASTCALL SH2movbl4(SH2_struct * sh)
{
   ...
   sh->regs.R[0] = (s32)(s8)MappedMemoryReadByteSh2(sh->regs.R[m] + disp, sh);
   sh->regs.PC+=2;
   sh->cycles++;
}
...
static void FASTCALL SH2movblg(SH2_struct * sh)
{
   ...
   sh->regs.R[0] = (s32)(s8)MappedMemoryReadByteSh2(sh->regs.GBR + disp, sh);
   sh->regs.PC+=2;
   sh->cycles++;
}
...
//   if (sh->regs.PC != 0x060170d2)
   MappedMemoryWriteByteSh2((sh->regs.R[n] - 1), sh->regs.R[m], sh);
   sh->regs.R[n] -= 1;
   sh->regs.PC += 2;
   sh->cycles++;
}
...
static void FASTCALL SH2movbs(SH2_struct * sh)
{
   ...
   MappedMemoryWriteByteSh2(sh->regs.R[b], sh->regs.R[c], sh);
   sh->regs.PC += 2;
   sh->cycles++;
}
...
{
   MappedMemoryWriteByteSh2(sh->regs.R[INSTRUCTION_B(sh->instruction)] + sh->regs.R[0],
      sh->regs.R[INSTRUCTION_C(sh->instruction)], sh);
   sh->regs.PC += 2;
   sh->cycles++;
}
...
static void FASTCALL SH2movbs4(SH2_struct * sh)
{
   ...
   MappedMemoryWriteByteSh2(sh->regs.R[n] + disp, sh->regs.R[0], sh);
   sh->regs.PC+=2;
   sh->cycles++;
}
...
static void FASTCALL SH2movbsg(SH2_struct * sh)
{
   ...
   MappedMemoryWriteByteSh2(sh->regs.GBR + disp, sh->regs.R[0], sh);
   sh->regs.PC += 2;
   sh->cycles++;
}
...
static void FASTCALL SH2movli(SH2_struct * sh)
{
   ...
   sh->regs.R[n] = MappedMemoryReadLongSh2(((sh->regs.PC + 4) & 0xFFFFFFFC) + (disp << 2), sh);
   sh->regs.PC += 2;
   sh->cycles++;
}
...
{
   sh->regs.R[INSTRUCTION_B(sh->instruction)] = MappedMemoryReadLongSh2(sh->regs.R[INSTRUCTION_C(sh->instruction)], sh);
   sh->regs.PC += 2;
   sh->cycles++;
}
...
{
   sh->regs.R[INSTRUCTION_B(sh->instruction)] = MappedMemoryReadLongSh2(sh->regs.R[INSTRUCTION_C(sh->instruction)] + sh->regs.R[0], sh);
   sh->regs.PC += 2;
   sh->cycles++;
}
...
static void FASTCALL SH2movll4(SH2_struct * sh)
{
   ...
   sh->regs.R[n] = MappedMemoryReadLongSh2(sh->regs.R[m] + (disp << 2), sh);
   sh->regs.PC += 2;
   sh->cycles++;
}
...
static void FASTCALL SH2movllg(SH2_struct * sh)
{
   ...
   sh->regs.R[0] = MappedMemoryReadLongSh2(sh->regs.GBR + (disp << 2), sh);
   sh->regs.PC+=2;
   sh->cycles++;
}
...
static void FASTCALL SH2movlm(SH2_struct * sh)
{
   ...
   MappedMemoryWriteLongSh2(sh->regs.R[n] - 4,sh->regs.R[m],sh);
   sh->regs.R[n] -= 4;
   sh->regs.PC += 2;
   sh->cycles++;
}
...
static void FASTCALL SH2movlp(SH2_struct * sh)
{
   ...
   sh->regs.R[n] = MappedMemoryReadLongSh2(sh->regs.R[m],sh);
...
static void FASTCALL SH2movls(SH2_struct * sh)
{
   ...
   MappedMemoryWriteLongSh2(sh->regs.R[b], sh->regs.R[c],sh);
   sh->regs.PC += 2;
   sh->cycles++;
}
...
{
   MappedMemoryWriteLongSh2(sh->regs.R[INSTRUCTION_B(sh->instruction)] + sh->regs.R[0],
                         sh->regs.R[INSTRUCTION_C(sh->instruction)],sh);
   sh->regs.PC += 2;
   sh->cycles++;
}
...
static void FASTCALL SH2movls4(SH2_struct * sh)
{
   ...
   MappedMemoryWriteLongSh2(sh->regs.R[n]+(disp<<2),sh->regs.R[m],sh);
   sh->regs.PC += 2;
   sh->cycles++;
}
...
static void FASTCALL SH2movlsg(SH2_struct * sh)
{
   ...
   MappedMemoryWriteLongSh2(sh->regs.GBR+(disp<<2),sh->regs.R[0],sh);
   sh->regs.PC+=2;
   sh->cycles++;
}
...
static void FASTCALL SH2movwi(SH2_struct * sh)
{
   ...
   sh->regs.R[n] = (s32)(s16)MappedMemoryReadWordSh2(sh->regs.PC + (disp<<1) + 4,sh);
   sh->regs.PC+=2;
   sh->cycles++;
}
...
static void FASTCALL SH2movwl(SH2_struct * sh)
{
   ...
   //if (sh->regs.PC == 0x06030d4c)
   //   sh->regs.R[n] = 0 >> 3;
   //else
   sh->regs.R[n] = (s32)(s16)MappedMemoryReadWordSh2(sh->regs.R[m],sh);
   sh->regs.PC += 2;
   sh->cycles++;
}
...
static void FASTCALL SH2movwl0(SH2_struct * sh)
{
   ...
   sh->regs.R[n] = (s32)(s16)MappedMemoryReadWordSh2(sh->regs.R[m]+sh->regs.R[0],sh);
   sh->regs.PC+=2;
   sh->cycles++;
}
...
static void FASTCALL SH2movwl4(SH2_struct * sh)
{
   ...
   sh->regs.R[0] = (s32)(s16)MappedMemoryReadWordSh2(sh->regs.R[m]+(disp<<1),sh);
   sh->regs.PC+=2;
   sh->cycles++;
}
...
static void FASTCALL SH2movwlg(SH2_struct * sh)
{
   ...
   sh->regs.R[0] = (s32)(s16)MappedMemoryReadWordSh2(sh->regs.GBR+(disp<<1),sh);
   sh->regs.PC += 2;
   sh->cycles++;
}
...
static void FASTCALL SH2movwm(SH2_struct * sh)
{
   ...
   MappedMemoryWriteWordSh2(sh->regs.R[n] - 2,sh->regs.R[m],sh);
   sh->regs.R[n] -= 2;
   sh->regs.PC += 2;
   sh->cycles++;
}
...
static void FASTCALL SH2movws(SH2_struct * sh)
{
   ...
   MappedMemoryWriteWordSh2(sh->regs.R[n],sh->regs.R[m],sh);
   sh->regs.PC += 2;
   sh->cycles++;
}
...
{
   MappedMemoryWriteWordSh2(sh->regs.R[INSTRUCTION_B(sh->instruction)] + sh->regs.R[0],
                         sh->regs.R[INSTRUCTION_C(sh->instruction)],sh);
   sh->regs.PC+=2;
   sh->cycles++;
}
...
static void FASTCALL SH2movws4(SH2_struct * sh)
{
   ...
   //if (sh->regs.PC >= 0x06031482 &&
   //   sh->regs.PC <= 0x06031592)//0x06031130
   //{
   //   int i = 0;
   //}
   //else
   ...
   //0x060314e6 texture address
   //0x060314ee texture size written
   //0x0603152a cmdpmod? clipping etc
   //0x06031546 color bank
   //0x0603154c x coordinate
   //0x06031552 y coordinate
   //if (sh->regs.PC == 0x060314e6)
   //{
   //   MappedMemoryWriteWordSh2(sh->regs.R[n] + (disp << 1), 0xfffc);
   //}
   //else
      MappedMemoryWriteWordSh2(sh->regs.R[n]+(disp<<1),sh->regs.R[0],sh);

   if ((sh->regs.R[0] << 3) == 0x7FFE0)
   {
      int i = 0;
   }
   sh->regs.PC+=2;
...
static void FASTCALL SH2movwsg(SH2_struct * sh)
{
   ...
   MappedMemoryWriteWordSh2(sh->regs.GBR+(disp<<1),sh->regs.R[0],sh);
   sh->regs.PC+=2;
   sh->cycles++;
}
...
static void FASTCALL SH2rte(SH2_struct * sh)
{
   u32 temp;
   temp=sh->regs.PC;
   sh->regs.PC = MappedMemoryReadLongSh2(sh->regs.R[15],sh);
   sh->regs.R[15] += 4;
   sh->regs.SR.all = MappedMemoryReadLongSh2(sh->regs.R[15],sh) & 0x000003F3;
   sh->regs.R[15] += 4;
   sh->cycles += 4;
   SH2delay(sh, temp + 2);
}
...
static void FASTCALL SH2stcmgbr(SH2_struct * sh)
{
   s32 n = INSTRUCTION_B(sh->instruction);
   sh->regs.R[n]-=4;
   MappedMemoryWriteLongSh2(sh->regs.R[n],sh->regs.GBR,sh);
   sh->regs.PC+=2;
   sh->cycles += 2;
}
...
static void FASTCALL SH2stcmsr(SH2_struct * sh)
{
   s32 n = INSTRUCTION_B(sh->instruction);
   sh->regs.R[n]-=4;
   MappedMemoryWriteLongSh2(sh->regs.R[n],sh->regs.SR.all,sh);
   sh->regs.PC+=2;
   sh->cycles += 2;
}
...
static void FASTCALL SH2stcmvbr(SH2_struct * sh)
{
   s32 n = INSTRUCTION_B(sh->instruction);
   sh->regs.R[n]-=4;
   MappedMemoryWriteLongSh2(sh->regs.R[n],sh->regs.VBR,sh);
   sh->regs.PC+=2;
   sh->cycles += 2;
}
...
static void FASTCALL SH2stsmmach(SH2_struct * sh)
{
   s32 n = INSTRUCTION_B(sh->instruction);
   sh->regs.R[n] -= 4;
   MappedMemoryWriteLongSh2(sh->regs.R[n],sh->regs.MACH,sh); 
   sh->regs.PC+=2;
   sh->cycles++;
}
...
static void FASTCALL SH2stsmmacl(SH2_struct * sh)
{
   s32 n = INSTRUCTION_B(sh->instruction);
   sh->regs.R[n] -= 4;
   MappedMemoryWriteLongSh2(sh->regs.R[n],sh->regs.MACL,sh);
   sh->regs.PC+=2;
   sh->cycles++;
}
...
static void FASTCALL SH2stsmpr(SH2_struct * sh)
{
   s32 n = INSTRUCTION_B(sh->instruction);
   sh->regs.R[n] -= 4;
   MappedMemoryWriteLongSh2(sh->regs.R[n],sh->regs.PR,sh);
   sh->regs.PC+=2;
   sh->cycles++;
}
...
static void FASTCALL SH2tas(SH2_struct * sh)
{
   ...
   temp=(s32) MappedMemoryReadByteSh2(sh->regs.R[n],sh);
   ...
   temp|=0x00000080;
   MappedMemoryWriteByteSh2(sh->regs.R[n],temp,sh);
   sh->regs.PC+=2;
   sh->cycles += 4;
}
...
static void FASTCALL SH2trapa(SH2_struct * sh)
{
   ...
   sh->regs.R[15]-=4;
   MappedMemoryWriteLongSh2(sh->regs.R[15],sh->regs.PC + 2,sh);
   sh->regs.PC = MappedMemoryReadLongSh2(sh->regs.VBR+(imm<<2),sh);
   sh->cycles += 8;
}
...
static INLINE void SH2UBCInterrupt(SH2_struct *context, u32 flag)
{
   ...
   {
      context->regs.R[15] -= 4;
      MappedMemoryWriteLongSh2(context->regs.R[15], context->regs.SR.all,context);
      context->regs.R[15] -= 4;
      MappedMemoryWriteLongSh2(context->regs.R[15], context->regs.PC,context);
      context->regs.SR.part.I = 15;
      context->regs.PC = MappedMemoryReadLongSh2(context->regs.VBR + (12 << 2),context);
...
static INLINE void SH2HandleInterrupts(SH2_struct *context)
{
   if (context->NumberOfInterrupts != 0)
   {
      if (context->interrupts[context->NumberOfInterrupts-1].level > context->regs.SR.part.I)
      {
         ...
         context->regs.PC = MappedMemoryReadLongSh2(context->regs.VBR + (context->interrupts[context->NumberOfInterrupts-1].vector << 2),context);
...
FASTCALL void SH2DebugInterpreterExec(SH2_struct *context, u32 cycles)
{
   ...
   while(context->cycles < cycles)
   {
      ...
      if (context->regs.PC == 0x6030d4c)
      {
         int i = 0;
      }

      if (context->regs.PC == 0x60314ce)
      {
         int i = 0;
      }

      if (context->regs.PC == 0x20000340)
      {
         int test = 0;
         test = 1;
      }

      if (context->regs.PC == 0x20000344)
      {
         int test = 0;
         test = 1;
      }

      if (context->regs.PC == 0x0000340)
      {
         int test = 0;
         test = 1;
      }
      if (context->regs.PC == 0x0000344)
      {
         int test = 0;
         test = 1;
      }
